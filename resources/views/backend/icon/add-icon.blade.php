                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>Add icon
                                    <a class="btn btn-success float-right" href="{{ route('icon.view') }}"><i
                                            class="fa fa-list"></i>icon List</a>
                                </h3>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <form method="post" action="{{ route('icon.store') }}" id="myform" autocomplete="off"
