            ...
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @else
                  <img class="profile-user-img img-fluid img-circle" src="/upload/no_image.png" alt="User profile picture">
                  @endif
                    </td>
                  <td>
                    ...
                    href="{{route('slider.delete',$slider->id)}}"><i class="fa fa-trash">
                    </i></a>
                  </td>
                </tr>
                @endforeach
